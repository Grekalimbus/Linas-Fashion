...
const ThirdDisplay = () => {
  ...
  return (
    <div className="mx-auto  w-full h-[110vh] flex flex-col justify-center items-center max-[1124px]:h-full bg-[#04111b]  py-20">
      <div className="container mx-auto w-full flex max-w-6xl max-[1124px]:w-[350px] max-[1124px]:flex-col relative max-[1124px]:justify-between">
        <div className="flex flex-col ">
          <AnimateWrap className="text-white font-bold text-8xl w-[100px] max-[1124px]:text-7xl ">
            02
          </AnimateWrap>
          <AnimateWrap
            tag="img"
            src={images[2]}
            alt="model"
            className="relative w-[75%]  z-[0] object-cover mt-[10px] ml-[160px] max-[1124px]:order-2 max-[1124px]:ml-0 max-[1124px]:mt-10"
          />
          <AnimateWrap
            tag="img"
            src={images[1]}
          ...
          <AnimateWrap
            tag="h1"
            className="font-semibold mt-20 max-[1152px]:mt-10"
          >
            FLOWER GARDEN
          </AnimateWrap>
          <AnimateWrap tag="p" className="font-light mt-1 underline  ">
            Learn more about the project →
          </AnimateWrap>
          <AnimateWrap
            tag="p"
            className=" font-light w-[140px] absolute z-[1] right-10 bottom-10 max-[1124px]:right-20 max-[1124px]:bottom-4"
          >
            Model: Jake James
          </AnimateWrap>
        </div>
